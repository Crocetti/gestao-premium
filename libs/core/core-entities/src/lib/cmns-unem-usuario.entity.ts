...
import type { ICmnsGrupoUsuario, ICmnsUsuario } from '@gpremium/cmns-interfaces';
import type { ICoreUnidadeEmpresarial, ICmnsUnemUsuario } from '@gpremium/core-interfaces';
