...
export default class SstmParametro {
  ...
  @Column("bit", { name: "PRMT_VISIVEL", nullable: true })
  public prmtVisivel?: boolean | null;
  ...
  @Column("bit", { name: "PRMT_HABILITADO", nullable: true })
  public prmtHabilitado?: boolean | null;
