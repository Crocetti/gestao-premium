...
export default class EstqMercadoria {
  ...
  @Column("bit", { name: "MRCD_ESTOQUE_NEGATIVO", nullable: true })
  public mrcdEstoqueNegativo?: boolean | null;

  @Column("bit", { name: "MRCD_CONTROLA_LOTE", nullable: true })
  public mrcdControlaLote?: boolean | null;
