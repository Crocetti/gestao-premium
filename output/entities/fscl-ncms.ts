...
export default class FsclNcms {
  ...
  @Column("bit", { name: "NCMS_TRIBUTA_PIS", nullable: true })
  public ncmsTributaPis?: boolean | null;

  @Column("bit", { name: "NCMS_TRIBUTA_COFINS", nullable: true })
  public ncmsTributaCofins?: boolean | null;

  @Column("bit", { name: "NCMS_RETEM_PIS", nullable: true })
  public ncmsRetemPis?: boolean | null;

  @Column("bit", { name: "NCMS_RETEM_COFINS", nullable: true })
  public ncmsRetemCofins?: boolean | null;

  @Column("bit", { name: "NCMS_RETEM_CSLL", nullable: true })
  public ncmsRetemCsll?: boolean | null;
